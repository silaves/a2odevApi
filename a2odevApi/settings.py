"""
Django settings for a2odevApi project.
...
SECRET_KEY = '4_#gr%m!!q8-+ia@b!s4sk4wu7e(ol1*8m5v6samy2ubm3)9^9'
...
WSGI_APPLICATION = 'a2odevApi.wsgi.application'
